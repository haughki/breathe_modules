...
Breathe.add_commands(
    ...
    mapping = {
        ...
        "sue dop": Text("sudop") + Key("enter"),

        "direct registration dev": Text("cd /apps/user/gRED/cdd/software/venvs/dev/cdd_peptide_reg_dev/lib/python3.12/site-packages/cdd_peptide_reg") + Key("enter"),
        ...
        "direct logs dev": Text("cd /gpfs/homefs/site/home/pepis/pepre.resources/dev/log.files") + Key("enter"),
        "direct data loader files dev": Text("cd /gpfs/homefs/site/home/pepis/pepre.resources/dev/log.files/data_loader_files") + Key("enter"),
        "activate uv dev": Text("source /apps/user/gRED/cdd/software/venvs/dev/cdd_peptide_reg_dev/bin/activate") + Key("enter"),
